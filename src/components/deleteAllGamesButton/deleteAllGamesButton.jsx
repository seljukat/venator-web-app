...
import { deleteAllGames } from "@/lib/action";
import { useState } from "react";

import styles from "./deleteAllGamesButton.module.css";

const DeleteAllGamesButton = () => {
  ...
  return (
    ...
    <>
      ...
      <form action={deleteAllGames} onSubmit={handleDeleteCount}>
        {showConfirmation ? (
          ...
          <div className="backdrop-blur-md bg-[#2d2b42] bg-opacity-50 w-[30%] flex items-center justify-evenly rounded-3xl border-8 border-slate-700 shadow-2xl shadow-[#2d2b42] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
...
export default DeleteAllGamesButton;
