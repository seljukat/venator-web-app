...
import { deleteUserGames } from "@/lib/action";
import { useState } from "react";

import styles from "./deleteUserGamesButton.module.css";

const DeleteUserGamesButton = ({ currentUser }) => {
  ...
  return (
    ...
    <>
      ...
      <form action={deleteUserGames} onSubmit={handleDeleteCount}>
...
export default DeleteUserGamesButton;
